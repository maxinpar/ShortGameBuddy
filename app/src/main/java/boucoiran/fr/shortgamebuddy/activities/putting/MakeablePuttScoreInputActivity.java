...
public class MakeablePuttScoreInputActivity extends AppCompatActivity {
    ...
    private void setSwipeListeners() {
        ...
        mainLayout.setOnTouchListener(new OnSwipeTouchListener(MakeablePuttScoreInputActivity.this) {
